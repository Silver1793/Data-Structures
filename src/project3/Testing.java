...
public class Testing {
    public static void main(String[] args) {
    	...
    	System.out.println(intList.find(null));
        ...
        intList.add(5,0);
        System.out.println(intList.remove((Integer) 4));
        System.out.println("Above should print null");
        System.out.println(intList.remove((Integer)5));
        System.out.println("Above should print 5");

        intList.add(5, 0);
        intList.add(10, 1);
        System.out.println("The list looks like: " + intList);
        System.out.println(intList.getTail());
        ...
        MyList<Integer> myList3 = myList2;
        MyStack<Integer> myStack9 = new MyStack();
        System.out.println(myList2.equals(myStack9));
        System.out.println("Above should print false");
        ...
        MyStack<Integer> intStack4 = new MyStack();
        MyStack<Integer> intStack5 = intStack4;
        System.out.println(intStack4.equals(intStack4));
        System.out.println("Above should print true");
        
        System.out.println(intStack4.equals(intList));
        System.out.println("Above should print false");
        ...
        System.out.println("Above should print 'The queue is empty'");
        intQueue.enqueue(1);
        ...
        MyQueue<Integer> intQueue8 = new MyQueue<>(); 
        MyQueue<Integer> intQueue9 = new MyQueue<>(); 
        MyQueue<Integer> intQueue10 = intQueue9;
        ...
        System.out.println(intQueue9.equals(intQueue8));
        System.out.println("Above should print false");
        
        System.out.println(intQueue9.equals(intList));
        System.out.println("Above should print false");
        
        System.out.println(intQueue9.equals(intQueue10));
        System.out.println("Above should print true");
